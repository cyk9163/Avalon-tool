  ...
  return {
    ...
    tiers: tiers(id, steps.map(([title, hint, role, facts, needSample, needQualify]) => ({
      ...
      met: (games: CareerGame[]) => {
        ...
        return enough(sample.length, got, needSample, needQualify);
      },
    }))),
  };
}
...
export const RANK_TRACKS: Track[] = [
  ...
  roleTrack("percival-rank", "派西维尔", games => ({ n: ofRole(games, "percival").length, a: withFact(games, "percival", ["b2", "b3"]).length, b: withFact(games, "percival", ["b3"]).length }), "派西 {n} 局，两车 {a}，三车 {b}", [
    ["当仁不让", "作为派西维尔至少打完 3 局。在你全部的派西维尔对局中，至少上过两车的局不少于 60%。再打的派西维尔对局也计入这个比例。", "percival", ["b2", "b3"], 3, 60],
    ["身先士卒", "作为派西维尔至少打完 5 局。在你全部的派西维尔对局中，至少上过两车的局不少于 60%。再打的派西维尔对局也计入这个比例。", "percival", ["b2", "b3"], 5, 60],
    ["节奏大师", "作为派西维尔至少打完 6 局。在你全部的派西维尔对局中，至少上过三车的局不少于 30%。再打的派西维尔对局也计入这个比例。", "percival", ["b3"], 6, 30],
    ["舍我其谁", "作为派西维尔至少打完 8 局。在你全部的派西维尔对局中，至少上过三车的局不少于 50%。再打的派西维尔对局也计入这个比例。", "percival", ["b3"], 8, 50],
  ]),
  roleTrack("morgana-rank", "莫甘娜", games => ({ n: ofRole(games, "morgana").length, a: withFact(games, "morgana", ["paced"]).length }), "莫甘娜 {n} 局，带节奏 {a}", [
    ["以假乱真", "作为莫甘娜至少打完 2 局。在你全部的莫甘娜对局中，带成车或拐走派西维尔的局不少于 50%。再打的莫甘娜对局也计入这个比例。", "morgana", ["paced"], 2, 50],
    ["鱼目混珠", "作为莫甘娜至少打完 4 局。在你全部的莫甘娜对局中，带成车或拐走派西维尔的局不少于 50%。再打的莫甘娜对局也计入这个比例。", "morgana", ["paced"], 4, 50],
    ["假戏真做", "作为莫甘娜至少打完 6 局。在你全部的莫甘娜对局中，带成车或拐走派西维尔的局不少于 60%。再打的莫甘娜对局也计入这个比例。", "morgana", ["paced"], 6, 60],
    ["假面梅林", "作为莫甘娜至少打完 8 局。在你全部的莫甘娜对局中，带成车或拐走派西维尔的局不少于 75%。再打的莫甘娜对局也计入这个比例。", "morgana", ["paced"], 8, 75],
  ]),
  roleTrack("mordred-rank", "莫德雷德", games => ({ n: ofRole(games, "mordred").length, a: withFact(games, "mordred", ["hidden"]).length }), "莫德雷德 {n} 局，出红仍藏 {a}", [
    ["不露声色", "作为莫德雷德至少打完 2 局。在你全部的莫德雷德对局中，出过失败牌之后又上了成功任务的局不少于 50%。再打的莫德雷德对局也计入这个比例。", "mordred", ["hidden"], 2, 50],
    ["笑里藏刀", "作为莫德雷德至少打完 4 局。在你全部的莫德雷德对局中，出过失败牌之后又上了成功任务的局不少于 50%。再打的莫德雷德对局也计入这个比例。", "mordred", ["hidden"], 4, 50],
    ["深藏不露", "作为莫德雷德至少打完 6 局。在你全部的莫德雷德对局中，出过失败牌之后又上了成功任务的局不少于 60%。再打的莫德雷德对局也计入这个比例。", "mordred", ["hidden"], 6, 60],
    ["大隐于市", "作为莫德雷德至少打完 8 局。在你全部的莫德雷德对局中，出过失败牌之后又上了成功任务的局不少于 75%。再打的莫德雷德对局也计入这个比例。", "mordred", ["hidden"], 8, 75],
  ]),
  roleTrack("loyal-rank", "亚瑟的忠臣", games => ({ n: ofRole(games, "loyal").length, a: withFact(games, "loyal", ["sided"]).length }), "忠臣 {n} 局，好人车 {a}", [
    ["平民之光", "作为忠臣至少打完 3 局。在你全部的忠臣对局中，上过好人更多的车的局不少于 60%。再打的忠臣对局也计入这个比例。", "loyal", ["sided"], 3, 60],
    ["跟对好人", "作为忠臣至少打完 5 局。在你全部的忠臣对局中，上过好人更多的车的局不少于 60%。再打的忠臣对局也计入这个比例。", "loyal", ["sided"], 5, 60],
    ["铁票忠臣", "作为忠臣至少打完 8 局。在你全部的忠臣对局中，上过好人更多的车的局不少于 60%。再打的忠臣对局也计入这个比例。", "loyal", ["sided"], 8, 60],
    ["忠心耿耿", "作为忠臣至少打完 12 局。在你全部的忠臣对局中，上过好人更多的车的局不少于 65%。再打的忠臣对局也计入这个比例。", "loyal", ["sided"], 12, 65],
  ]),
  roleTrack("oberon-rank", "奥伯伦", games => ({ n: ofRole(games, "oberon").length, a: withFact(games, "oberon", ["sided"]).length }), "奥伯伦 {n} 局，好人车 {a}", [
    ["盲狼站对", "作为奥伯伦至少打完 2 局。在你全部的奥伯伦对局中，上过好人更多的车的局不少于 50%。再打的奥伯伦对局也计入这个比例。", "oberon", ["sided"], 2, 50],
    ["误上好车", "作为奥伯伦至少打完 4 局。在你全部的奥伯伦对局中，上过好人更多的车的局不少于 50%。再打的奥伯伦对局也计入这个比例。", "oberon", ["sided"], 4, 50],
    ["盲狼老手", "作为奥伯伦至少打完 6 局。在你全部的奥伯伦对局中，上过好人更多的车的局不少于 60%。再打的奥伯伦对局也计入这个比例。", "oberon", ["sided"], 6, 60],
    ["盲眼金水", "作为奥伯伦至少打完 8 局。在你全部的奥伯伦对局中，上过好人更多的车的局不少于 75%。再打的奥伯伦对局也计入这个比例。", "oberon", ["sided"], 8, 75],
  ]),
  roleTrack("minion-rank", "莫德雷德的爪牙", games => ({ n: ofRole(games, "minion").length, a: withFact(games, "minion", ["red"]).length }), "爪牙 {n} 局，出红 {a}", [
    ["初试红牌", "作为爪牙至少打完 2 局。在你全部的爪牙对局中，出过失败牌或上过失败任务的局不少于 50%。再打的爪牙对局也计入这个比例。", "minion", ["red"], 2, 50],
    ["红牌助手", "作为爪牙至少打完 4 局。在你全部的爪牙对局中，出过失败牌或上过失败任务的局不少于 50%。再打的爪牙对局也计入这个比例。", "minion", ["red"], 4, 50],
    ["爪牙冲锋", "作为爪牙至少打完 6 局。在你全部的爪牙对局中，出过失败牌或上过失败任务的局不少于 60%。再打的爪牙对局也计入这个比例。", "minion", ["red"], 6, 60],
    ["破坏常客", "作为爪牙至少打完 8 局。在你全部的爪牙对局中，出过失败牌或上过失败任务的局不少于 75%。再打的爪牙对局也计入这个比例。", "minion", ["red"], 8, 75],
  ]),
  roleTrack("cleric-rank", "牧师", games => ({ n: ofRole(games, "cleric").length, a: withFact(games, "cleric", ["read"]).length }), "牧师 {n} 局，看对 {a}", [
    ["初读风向", "作为牧师至少打完 2 局。在你全部的牧师对局中，至少两张票和任务结果一致的局不少于 50%。再打的牧师对局也计入这个比例。", "cleric", ["read"], 2, 50],
    ["牧师站对", "作为牧师至少打完 4 局。在你全部的牧师对局中，至少两张票和任务结果一致的局不少于 50%。再打的牧师对局也计入这个比例。", "cleric", ["read"], 4, 50],
    ["风向老手", "作为牧师至少打完 6 局。在你全部的牧师对局中，至少两张票和任务结果一致的局不少于 60%。再打的牧师对局也计入这个比例。", "cleric", ["read"], 6, 60],
    ["开局先知", "作为牧师至少打完 8 局。在你全部的牧师对局中，至少两张票和任务结果一致的局不少于 75%。再打的牧师对局也计入这个比例。", "cleric", ["read"], 8, 75],
  ]),
  roleTrack("good-lance-rank", "正义兰斯洛特", games => ({ n: ofRole(games, "goodLancelot").length, a: ofRole(games, "goodLancelot").filter(game => game.side === game.winner).length }), "正义兰斯洛特 {n} 局，胜 {a}", [
    ["初换阵营", "作为正义兰斯洛特至少打完 3 局。在你全部的正义兰斯洛特对局中，结束时你所在阵营获胜的局不少于 60%。再打的对局也计入这个比例。", "goodLancelot", [], 3, 60],
    ["换边仍胜", "作为正义兰斯洛特至少打完 5 局。在你全部的正义兰斯洛特对局中，结束时你所在阵营获胜的局不少于 60%。再打的对局也计入这个比例。", "goodLancelot", [], 5, 60],
    ["双面骑士", "作为正义兰斯洛特至少打完 8 局。在你全部的正义兰斯洛特对局中，结束时你所在阵营获胜的局不少于 60%。再打的对局也计入这个比例。", "goodLancelot", [], 8, 60],
    ["忠诚无常", "作为正义兰斯洛特至少打完 12 局。在你全部的正义兰斯洛特对局中，结束时你所在阵营获胜的局不少于 65%。再打的对局也计入这个比例。", "goodLancelot", [], 12, 65],
  ], true),
  roleTrack("evil-lance-rank", "邪恶兰斯洛特", games => ({ n: ofRole(games, "evilLancelot").length, a: ofRole(games, "evilLancelot").filter(game => game.side === game.winner).length }), "邪恶兰斯洛特 {n} 局，胜 {a}", [
    ["黑骑初胜", "作为邪恶兰斯洛特至少打完 3 局。在你全部的邪恶兰斯洛特对局中，结束时你所在阵营获胜的局不少于 60%。再打的对局也计入这个比例。", "evilLancelot", [], 3, 60],
    ["换边黑胜", "作为邪恶兰斯洛特至少打完 5 局。在你全部的邪恶兰斯洛特对局中，结束时你所在阵营获胜的局不少于 60%。再打的对局也计入这个比例。", "evilLancelot", [], 5, 60],
    ["双面黑骑", "作为邪恶兰斯洛特至少打完 8 局。在你全部的邪恶兰斯洛特对局中，结束时你所在阵营获胜的局不少于 60%。再打的对局也计入这个比例。", "evilLancelot", [], 8, 60],
    ["无常黑骑", "作为邪恶兰斯洛特至少打完 12 局。在你全部的邪恶兰斯洛特对局中，结束时你所在阵营获胜的局不少于 65%。再打的对局也计入这个比例。", "evilLancelot", [], 12, 65],
  ], true),
  roleTrack("lunatic-rank", "疯子", games => ({ n: ofRole(games, "lunatic").length, a: withFact(games, "lunatic", ["boardwin"]).length }), "疯子 {n} 局，上车仍胜 {a}", [
    ["疯牌上车", "作为疯子至少打完 2 局。在你全部的疯子对局中，上了车且邪恶获胜的局不少于 50%。再打的疯子对局也计入这个比例。", "lunatic", ["boardwin"], 2, 50],
    ["身不由己", "作为疯子至少打完 4 局。在你全部的疯子对局中，上了车且邪恶获胜的局不少于 50%。再打的疯子对局也计入这个比例。", "lunatic", ["boardwin"], 4, 50],
    ["疯牌常胜", "作为疯子至少打完 6 局。在你全部的疯子对局中，上了车且邪恶获胜的局不少于 60%。再打的疯子对局也计入这个比例。", "lunatic", ["boardwin"], 6, 60],
    ["失控仍胜", "作为疯子至少打完 8 局。在你全部的疯子对局中，上了车且邪恶获胜的局不少于 75%。再打的疯子对局也计入这个比例。", "lunatic", ["boardwin"], 8, 75],
  ]),
  roleTrack("brute-rank", "野蛮人", games => ({ n: ofRole(games, "brute").length, a: withFact(games, "brute", ["held"]).length }), "野蛮人 {n} 局，后期收手 {a}", [
    ["初学收手", "作为野蛮人至少打完 2 局。在你全部的野蛮人对局中，第四或第五次任务交出成功并且任务成功的局不少于 50%。再打的野蛮人对局也计入这个比例。", "brute", ["held"], 2, 50],
    ["后期收刀", "作为野蛮人至少打完 4 局。在你全部的野蛮人对局中，第四或第五次任务交出成功并且任务成功的局不少于 50%。再打的野蛮人对局也计入这个比例。", "brute", ["held"], 4, 50],
    ["收刀回鞘", "作为野蛮人至少打完 6 局。在你全部的野蛮人对局中，第四或第五次任务交出成功并且任务成功的局不少于 60%。再打的野蛮人对局也计入这个比例。", "brute", ["held"], 6, 60],
    ["金盆洗手", "作为野蛮人至少打完 8 局。在你全部的野蛮人对局中，第四或第五次任务交出成功并且任务成功的局不少于 75%。再打的野蛮人对局也计入这个比例。", "brute", ["held"], 8, 75],
  ]),
  roleTrack("revealer-rank", "揭露者", games => ({ n: ofRole(games, "revealer").length, a: withFact(games, "revealer", ["outwin"]).length }), "揭露者 {n} 局，曝光后胜 {a}", [
    ["揭牌仍在", "作为揭露者至少打完 2 局。在你全部的揭露者对局中，身份公开后邪恶获胜的局不少于 50%。再打的揭露者对局也计入这个比例。", "revealer", ["outwin"], 2, 50],
    ["曝光不败", "作为揭露者至少打完 4 局。在你全部的揭露者对局中，身份公开后邪恶获胜的局不少于 50%。再打的揭露者对局也计入这个比例。", "revealer", ["outwin"], 4, 50],
    ["揭牌老手", "作为揭露者至少打完 6 局。在你全部的揭露者对局中，身份公开后邪恶获胜的局不少于 60%。再打的揭露者对局也计入这个比例。", "revealer", ["outwin"], 6, 60],
    ["公开仍胜", "作为揭露者至少打完 8 局。在你全部的揭露者对局中，身份公开后邪恶获胜的局不少于 75%。再打的揭露者对局也计入这个比例。", "revealer", ["outwin"], 8, 75],
  ]),
];
