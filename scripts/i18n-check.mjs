...
export const UI_FILES = [
  ...
  "components/device-recovery.tsx", "components/early-assassination.tsx", "components/player-notes.tsx", "components/room-section-nav.tsx", "components/game-table.tsx", "components/vote-matrix.tsx", "components/speech-bar.tsx", "components/reveal-overlay.tsx", "lib/turn.ts", "lib/guide.ts", "components/guide-hint.tsx", "components/theme-toggle.tsx", "components/room-record.tsx", "components/big-screen.tsx", "app/screen/page.tsx", "components/role-info.tsx", "lib/role-info.ts", "lib/replay-image.ts", "components/rules-card.tsx", "components/doc-page.tsx", "components/game-panel.tsx", "components/install-app.tsx",
