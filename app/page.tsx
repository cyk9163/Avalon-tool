...
export default function Home(){
  ...
  return <main className={`app-shell ${room ? "is-room" : "is-home"}`}>
    ...
    <footer className="page-footer"><span className="footer-brand"><Crown size={14}/>把推理留在圆桌。</span><span className="footer-meta">面对面 · 5–10 人 · 房间保留 24 小时<nav className="footer-links" aria-label="站点信息"><Link href="/rules">规则教学</Link><Link href="/privacy">隐私说明</Link></nav></span></footer>
