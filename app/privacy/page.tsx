    ...
    >
      ...
      <section id="collect">
        ...
        <DocTable caption={t("服务器上的房间数据")}>
          ...
          <tbody>
            ...
            <tr><td>{t("任务牌")}</td><td>{t("判定任务成败、防止重复提交")}</td><td>{t("任何人都看不到谁出了什么，只公布失败牌数量")}</td></tr>
      ...
      <section id="device">
        ...
        <ul>
          ...
          <li><strong>{t("我的推理笔记")}</strong>{t("：你在对局中给其他玩家做的标记和发言备注，只存在这台设备，不上传服务器，其他玩家也看不到；保留最近 5 局，可以随时清空。")}</li>
      ...
      <section id="retention">
        ...
        <p>{t("圆桌没有永久战绩。需要留存复盘，请在结局页用“复制复盘文字”或“下载 .txt”自行导出；导出内容包含同桌昵称、身份和表决，但不包含谁出了哪张任务牌。")}</p>
      </section>
      ...
      <section id="hidden">
        ...
        <ul>
          ...
          <li>{t("表决收齐后才公开每个人的选择；任务牌与玩家的对应关系，结局后也不公开。")}</li>
